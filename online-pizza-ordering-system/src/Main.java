...
public class Main{
    public static void main(String[] args)
    {
        ...
        ph.accept_customer("Somil", "B-61, Prince Complex, Teen Talwar, Clifton",1, "3347354395");
        ph.accept_customer("Sannan", "Flat 581/D-2, PAF Base Malir, Malir Cantt",9, "3056442061");
        ph.accept_customer("Pawan", "Metro Twin Tower, Teen Talwar, Clifton",1, "3322903141");
