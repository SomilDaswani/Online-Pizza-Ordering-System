...
public void take_order() 
{
    ...
    do{
    System.out.print("\n\t\t\t\tEnter your mobile number : +92");      // input mobile number
    mobile = sc.next();
...
void print_bill(int customer_loc, ArrayList<Integer> pizza_choice, ArrayList<Character> sizes, ArrayList<Integer> qty)
{
    ...
    for(int i=0; i<pizza_choice.size(); i++) // iterate through the ordered pizzas list
    {
        ...
        estimated_time+= selected.time_read*qty.get(i);
    ...
    {
        System.out.print("\n\n\t\t\t\t\t"+confirm_order_msg+"\n\n\n\t\t\t\t\tYour Order will be delivered in " + estimated_time + " mins"); // print confirmation message
...
double shortest_dist(int customer_loc)
{
    ...
    double[][] adjMat = {
            ...
            { 0   ,inf , 10.5 , inf , 6.3 , inf, inf, inf, inf, 8.1 },    //1 Clifton : PizzaHut
            { inf , 0  , 5    , inf , inf , 5  , inf, inf, inf, inf},	  //2 Dha
            { 10.5, 5  , 0    , inf , inf , 4  , inf, inf, inf, inf},	  //3 Saddar
            {inf  , inf, inf  , 0   , 3.2 , inf, 6  , inf, 4.3, inf},     //4 Korangi
            { 6.3 , inf, inf  , 3.2 , 0   , 6.1, inf, inf, 6.8, 7.4},     //5 Shahrah-e-faisal
            { inf , 5  , 4    , inf , 6.1 , 0  , 4.7, inf, inf, inf},     //6 North Nazimabad
            { inf , inf, inf  , 6   , inf , 4.7, 0  , inf, inf, inf},     //7 Gulshan-e-iqbal
            { inf , inf, inf  , inf , inf , inf, inf, 0  , 5.6, 2.8},     //8 Gulistan-e-johar
            { inf , inf, inf  , 4.3 , 6.8 , inf, inf, 5.6, 0  , inf},     //9 Malir Cantt
            { 8.1 , inf, inf  , inf , 7.4 , inf, inf, 2.8, inf, 0}        //10 Bahria Town
    };
